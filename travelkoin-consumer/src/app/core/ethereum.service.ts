...
export class EthereumService {
    ...
    // loadTransaction(tx: EthereumTransaction): Observable<EthereumTransaction | null> {
    ...
    // }
    //
    // loadTransactions(txs: Array<EthereumTransaction>): Observable<Array<EthereumTransaction> | null> {
