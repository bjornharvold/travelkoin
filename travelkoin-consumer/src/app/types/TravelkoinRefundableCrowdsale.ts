...
export class TravelkoinRefundableCrowdsale extends SoltsiceContract {
    static get Artifacts() { return require('../contracts/TravelkoinRefundableCrowdsale.json'); }
    ...
    static async New(deploymentParams: W3.TX.TxParams, ctorParams?: {_goal: BigNumber | number}, w3?: W3, link?: SoltsiceContract[]): Promise<TravelkoinRefundableCrowdsale> {
        let contract = new TravelkoinRefundableCrowdsale(deploymentParams, ctorParams, w3, link);
        await contract._instancePromise;
        return contract;
    }

    static async At(address: string | object, w3?: W3): Promise<TravelkoinRefundableCrowdsale> {
        let contract = new TravelkoinRefundableCrowdsale(address, undefined, w3, undefined);
        await contract._instancePromise;
        return contract;
    }

    static async Deployed(w3?: W3): Promise<TravelkoinRefundableCrowdsale> {
