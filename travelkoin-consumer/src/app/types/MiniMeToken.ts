 ...
 * MiniMeToken API
 */
export class MiniMeToken extends SoltsiceContract {
    static get Artifacts() { return require('../contracts/MiniMeToken.json'); }

    static get BytecodeHash() {
        // we need this before ctor, but artifacts are static and we cannot pass it to the base class, so need to generate
        let artifacts = MiniMeToken.Artifacts;
    ...
    static async New(deploymentParams: W3.TX.TxParams, ctorParams?: {_tokenFactory: string, _parentToken: string, _parentSnapShotBlock: BigNumber | number, _tokenName: string, _decimalUnits: BigNumber | number, _tokenSymbol: string, _transfersEnabled: boolean}, w3?: W3, link?: SoltsiceContract[]): Promise<MiniMeToken> {
        let contract = new MiniMeToken(deploymentParams, ctorParams, w3, link);
        await contract._instancePromise;
        return contract;
    }

    static async At(address: string | object, w3?: W3): Promise<MiniMeToken> {
        let contract = new MiniMeToken(address, undefined, w3, undefined);
        await contract._instancePromise;
        return contract;
    }

    static async Deployed(w3?: W3): Promise<MiniMeToken> {
        let contract = new MiniMeToken('', undefined, w3, undefined);
        await contract._instancePromise;
        return contract;
    }
    ...
    protected constructor(
        ...
        ctorParams?: {_tokenFactory: string, _parentToken: string, _parentSnapShotBlock: BigNumber | number, _tokenName: string, _decimalUnits: BigNumber | number, _tokenSymbol: string, _transfersEnabled: boolean},
        w3?: W3,
        ...
        super(
            w3,
            MiniMeToken.Artifacts,
            ctorParams ? [ctorParams!._tokenFactory, ctorParams!._parentToken, ctorParams!._parentSnapShotBlock, ctorParams!._tokenName, ctorParams!._decimalUnits, ctorParams!._tokenSymbol, ctorParams!._transfersEnabled] : [],
            deploymentParams,
            link
        );
    }
    ...
    */
    ...
    public approve = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_spender: string, _amount: BigNumber | number, txParams?: W3.TX.TxParams): Promise<W3.TX.TransactionResult> => {
            return new Promise((resolve, reject) => {
            ...
            sendTransaction: Object.assign((_spender: string, _amount: BigNumber | number, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_spender: string, _amount: BigNumber | number, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.approve.request(_spender, _amount).params[0].data, txParams, nonce);
                    }
                }
            )
        },
            ...
            sendTransaction: Object.assign((_from: string, _to: string, _amount: BigNumber | number, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_from: string, _to: string, _amount: BigNumber | number, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.transferFrom.request(_from, _to, _amount).params[0].data, txParams, nonce);
                    }
                }
            )
        },
            ...
            sendTransaction: Object.assign((_to: string, _amount: BigNumber | number, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_to: string, _amount: BigNumber | number, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.transfer.request(_to, _amount).params[0].data, txParams, nonce);
                    }
                }
            )
        },
    ...
    public approveAndCall = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_spender: string, _amount: BigNumber | number, _extraData: string, txParams?: W3.TX.TxParams): Promise<W3.TX.TransactionResult> => {
            return new Promise((resolve, reject) => {
            ...
            sendTransaction: Object.assign((_spender: string, _amount: BigNumber | number, _extraData: string, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_spender: string, _amount: BigNumber | number, _extraData: string, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.approveAndCall.request(_spender, _amount, _extraData).params[0].data, txParams, nonce);
                    }
                }
            )
        },
        ...
        },
        {
            ...
            sendTransaction: Object.assign((_owner: string, _amount: BigNumber | number, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_owner: string, _amount: BigNumber | number, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.destroyTokens.request(_owner, _amount).params[0].data, txParams, nonce);
                    }
                }
            )
        },
    ...
    public enableTransfers = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_transfersEnabled: boolean, txParams?: W3.TX.TxParams): Promise<W3.TX.TransactionResult> => {
            return new Promise((resolve, reject) => {
            ...
            sendTransaction: Object.assign((_transfersEnabled: boolean, txParams?: W3.TX.TxParams): Promise<string> => {
                ...
                },
                {
                    ...
                    sendSigned: (_transfersEnabled: boolean, privateKey: string, txParams?: W3.TX.TxParams, nonce?: number): Promise<string> => {
                        // tslint:disable-next-line:max-line-length
                        return this.w3.sendSignedTransaction(this.address, privateKey, this._instance.enableTransfers.request(_transfersEnabled).params[0].data, txParams, nonce);
                    }
                }
            )
        },
