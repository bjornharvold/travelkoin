...
contract('NormalSale', function ([deployer, investor, wallet, purchaser, purchaser2, purchaser3, purchaser4]) {
    ...
    const maxContributionFirstTwentyFourHours = ether(1);
    ...
    beforeEach(async function () {
        ...
        this.crowdsale = await Crowdsale.new(this.controller.address, this.startTime, this.endTime, minContribution, maxContributionFirstTwentyFourHours, rate, cap, wallet);
    ...
    describe('accepting payments', function () {
        ...
        //
        //   await this.crowdsale.sendTransaction({ value: maxContributionFirstTwentyFourHours, from: purchaser3 }).should.be.fulfilled;
